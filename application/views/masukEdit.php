                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo base_url('index.php/masuk/addMasuk'); ?>">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="noSurat" name="noSurat" value="<?php echo $data['noSurat']; ?>" type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tglMasuk" class="control-label col-lg-2">Tanggal Masuk</label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="tglMasuk" name="tglMasuk" value="<?php echo $data['tanggalMasuk']; ?>" type="text" data-provide="tglMasuk" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="asalSurat" class="control-label col-lg-2">Asal Surat</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="asalSurat" name="asalSurat" value="<?php echo $data['asalSurat']; ?>" type="text" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tglTerima" class="control-label col-lg-2">Tanggal Terima</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="tglTerima" name="tglTerima" value="<?php echo $data['tanggalTerima']; ?>" type="text" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="noAgenda" class="control-label col-lg-2">Nomor Agenda</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="noAgenda" name="noAgenda" value="<?php echo $data['noAgenda']; ?>" type="text" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="perihal" class="control-label col-lg-2">Perihal</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="perihal" name="perihal" value="<?php echo $data['perihal']; ?>" type="text" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tembusan" class="control-label col-lg-2">Diteruskan Kepada</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="tembusan" name="tembusan" value="<?php echo $data['tembusan']; ?>" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="keterangan" class="control-label col-lg-2">Keterangan</label>
                                        <div class="col-lg-10">
                                            <textarea class="form-control" rows="5" id="keterangan" name="keterangan" value="<?php echo $data['keterangan']; ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
