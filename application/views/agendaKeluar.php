    ...
    <div class="container">
        <div id="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Agenda Keluar</li>
            </ol>
            <!-- end:breadcrumb -->
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Berikut data dari agenda keluar, <a href="<?php echo base_url('index.php/keluar/formBaru'); ?>"><strong>KLIK DISINI</strong></a> untuk menambahkan data baru
                        </header>
                                ...
                                <table  class="display table table-bordered table-striped" id="example">
                                    ...
                                    <?php foreach ($data as $row){ ?>
                                        <tr class="gradeC">
                                            ...
                                            <td class="center hidden-phone"><?php echo $row['tujuan']; ?></td>
                                            <td class="center hidden-phone"><?php echo $row['perihal']; ?></td>
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#detailModal<?php echo $row['idKeluar']; ?>"><i class="fa fa-search"></i></button>
                                                    <a href="<?php echo base_url('index.php/keluar/editKeluar/'.$row['idKeluar']); ?>" type="button" class="btn btn-success"><i class="fa fa-clipboard"></i></a>
                                                </div>
                                            </td>
                                            <!-- Modal -->
                                            <div class="modal fade" id="detailModal<?php echo $row['idKeluar']; ?>" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">ID Agenda Masuk : <?php echo $row['idKeluar']; ?></h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-1">:</div>
                                                                <div class="col-md-5"><?php echo $row['tglSurat']; ?></div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">Tujuan</div>
                                                                <div class="col-md-1">:</div>
                                                                <div class="col-md-5"><?php echo $row['tujuan']; ?></div>
                                                            </div>
                                                            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-phone">Tujuan</th>
                                        <th class="hidden-phone">Perihal</th>
                                        <th><a href="#print" data-toggle="modal" type="button" class="btn btn-info">Print Rekap</a></th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
                        </div>
                        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="print" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" action="<?php echo base_url('index.php/keluar/printKeluar'); ?>" method="post">
                                            <div class="form-group">
                                                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Bulan</label>
                                                <div class="col-lg-10">
                                                    <select class="form-control" id="inputEmail4" name="bulan">
                                            ...
                                            <div class="form-group">
                                                <label for="inputTahun" class="col-lg-2 col-sm-2 control-label">Password</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" id="inputTahun" placeholder="Masukkan Tahun" name="tahun">
                                                </div>
                                            </div>
                                            <div class="form-group">
