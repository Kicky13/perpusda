                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo base_url('index.php/keluar/updateKeluar/'.$row->idKeluar); ?>">
                                    <div class="form-group ">
                                        <label for="noSurat" class="control-label col-lg-2">Nomor Surat</label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="noSurat" name="noSurat" value="<?php echo $row->noSurat; ?>" type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tglSurat" class="control-label col-lg-2">Tanggal Surat</label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="tglSurat" name="tglSurat" value="<?php echo $row->tanggalSurat; ?>" type="text" data-provide="tglSurat" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tujuan" class="control-label col-lg-2">Tujuan Surat</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="tujuan" name="tujuan" value="<?php echo $row->tujuan; ?>" type="text" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="perihal" class="control-label col-lg-2">Perihal</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="perihal" name="perihal" value="<?php echo $row->perihal; ?>" type="text" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            ...
                                            <a href="<?php echo base_url('index.php/keluar'); ?>" class="btn btn-default" type="button">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                                <?php } ?>
