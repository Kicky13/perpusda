                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo base_url('index.php/keluar/addKeluar'); ?>">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="tglSurat" name="tglSurat" type="text" data-provide="tglSurat" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
